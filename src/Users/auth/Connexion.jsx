      ...
      <div className='mx-auto grid min-h-[calc(100vh-3rem)] max-w-6xl items-center overflow-hidden rounded-3xl border border-base-300 bg-[var(--surface)] shadow-2xl shadow-base-content/10 lg:grid-cols-2'>
        <section className='home-hero relative hidden min-h-[620px] flex-col justify-between overflow-hidden p-10 text-primary-content lg:flex xl:p-14'>
          ...
          <div className='relative'>
            <Link to='/connexion' className='inline-flex items-center gap-3 text-xl font-bold tracking-tight'>
            ...
            <p className='mt-5 max-w-md text-base leading-7 text-primary-content/75'>
              Connectez-vous pour retrouver vos produits, vos favoris et une sélection pensée pour vous.
            </p>
          </div>
        ...
        <section className='mx-auto w-full max-w-md p-7 sm:p-10 lg:p-14'>
          <div className='mb-8 lg:hidden'>
            <Link to='/connexion' className='inline-flex items-center gap-2 text-lg font-bold text-base-content'>
          ...
          <div className='mb-8'>
            <p className='text-sm font-bold uppercase tracking-[0.2em] text-primary'>Bon retour</p>
            <h1 className='mt-2 text-3xl font-extrabold tracking-tight text-base-content'>Se connecter</h1>
            <p className='mt-2 text-sm leading-6 text-base-content/60'>Accédez à votre espace personnel et continuez vos achats.</p>
          </div>
          ...
          <form className='flex flex-col gap-5' onSubmit={handleSubmit}>
            ...
            <div className='flex justify-end'>
              <button type='button' className='text-sm font-semibold text-primary hover:underline'>Mot de passe oublié ?</button>
            </div>
          ...
          <p className='mt-8 text-center text-sm text-base-content/65'>
            Pas encore de compte ? <Link className='font-bold text-primary hover:underline' to='/inscription'>S&apos;inscrire</Link>
          </p>
        </section>
      </div>
    </div>
