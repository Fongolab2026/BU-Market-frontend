...
export function MerchantDetailPage() {
  ...
  const updateStatus = async (status) => {
    setBusy(true)
    const nextUser = await adminService.updateUserStatus(user.id, status)
    setUser({ ...nextUser })
    setBusy(false)
  ...
  const toggleProduct = async (product) => {
    ...
    setBusy(true)
    const nextUser = await adminService.updateProductStatus(user.shop.id, product.id, nextStatus)
    setUser({ ...nextUser })
    setBusy(false)
  ...
  const toggleReview = async (review) => {
    ...
    setBusy(true)
    const nextUser = await adminService.updateReviewStatus(user.shop.id, review.id, nextStatus)
    setUser({ ...nextUser })
    setBusy(false)
  ...
  const handleDeleteShop = async () => {
    setBusy(true)
    const nextUser = await adminService.deleteShop(user.shop.id)
    setUser({ ...nextUser })
    setBusy(false)
    setConfirm(null)
